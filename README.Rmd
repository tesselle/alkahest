...
Pre-Process XY Data from Experimental Methods. **alkahest** is a toolbox for pre-processing XY data from experimental methods (i.e. any signal that can be measured along a continuous variable). It provides methods for baseline correction, smoothing, normalization and integration.
