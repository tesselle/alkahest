...
## Correct baseline
corrected <- signal_drift(XRD, lag = baseline, substract = TRUE)
...
## Correct baseline
corrected <- signal_drift(BEGe, lag = baseline, substract = TRUE)

plot(corrected, type = "l", xlab = "Energy (keV)", ylab = "Count")
```
...
## Plot spectrum
plot(XRD, type = "l", xlab = "Energy (keV)", ylab = "Count")
